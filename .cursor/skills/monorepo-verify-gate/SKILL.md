...
| `registry-meta`          | `packages/registry/src/items/**` only (no UI template change)                                 | `pnpm registry:check`                                                                   |
...
- [`$docs-alignment`](../../.agents/skills/docs-alignment/SKILL.md) — catalog audit commands in `docs-only` / path fallback
