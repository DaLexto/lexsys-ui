...
description: >
  ...
  H2 order, required On this page (≥4 substantive H2), Related documentation footer.
  Use for new docs, layout retrofit, or package README scaffolding — not post-code freshness.
---
...
4. **On this page** — **required** after `---` when ≥4 substantive H2 sections (exclude `On this page` / `Related documentation` from count); follow documentation-standards § On this page (ASCII `-` in linked headings, label = heading text, verify `#fragment` in preview).
