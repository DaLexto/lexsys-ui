...
describe("createStyleOutputs", () => {
  ...
  test("generates token and theme css from token source", () => {
    ...
    expect(outputs.tokensCss).toContain("--lex-color-blue-600")
    expect(outputs.tokensCss).toContain(
    ...
    expect(outputs.tokensCss).toContain("--lex-line-height-normal: 1.5")
    expect(outputs.tokensCss).not.toContain("--lex-line-height-6")
    expect(outputs.tokensCss).toContain(
    ...
    expect(outputs.themeCss).toContain("--lex-color-background-base")
    expect(outputs.themeCss).toContain(".dark")
    expect(outputs.themeCss).toContain("@theme inline")
    expect(outputs.themeCss).toContain("--lex-action-primary-base")
    expect(outputs.themeCss).toContain("--lex-border-focus")
  ...
  test("generates tokens css from DTCG json input", () => {
    ...
    expect(css).toContain("--lex-color-blue-600")
    expect(css).toContain("--lex-radius-control: var(--lex-radius-md)")
    expect(css).toContain("--lex-button-radius: var(--lex-radius-control)")
    expect(css).toContain(
      "--lex-brand-color-primary-base: var(--lex-color-orange-600)",
    )
    expect(css).toContain("--lex-size-overlay-list-max-height")
    expect(css).toContain("--lex-space-overlay-side-offset")
    expect(css).toContain("--lex-elevation-behind-z-index")
    expect(css).toContain("--lex-toast-viewport-max-height")
    expect(css).toContain("--lex-select-positioner-side-offset")
    expect(css).toContain("--lex-select-backdrop-opacity")
    expect(css).toContain("--lex-toast-motion-offset-y")
    expect(css).toContain("--lex-drawer-viewport-max-height")
    expect(css).not.toContain("--lex-$schema")
    expect(css).not.toContain("--lex-$extensions")
  })
  ...
  test("omits dead primitive CSS variables when stripDeadPrimitives is on", () => {
    ...
    expect(strippedOutputs.tokensCss).not.toContain("--lex-color-blue-100:")
    expect(defaultOutputs.tokensCss).toContain("--lex-color-blue-100:")
  })
