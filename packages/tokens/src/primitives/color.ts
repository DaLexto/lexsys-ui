...
export const colorPrimitives: PrimitiveTokenGroup = {
  ...
  yellow: {
    ...
    50: { $value: oklch(0.987, 0.026, 92.0) },
    100: { $value: oklch(0.973, 0.051, 92.0) },
    200: { $value: oklch(0.946, 0.089, 92.0) },
    300: { $value: oklch(0.906, 0.13, 92.0) },
    400: { $value: oklch(0.852, 0.168, 92.0) },
    500: { $value: oklch(0.79, 0.178, 92.0) },
    600: { $value: oklch(0.706, 0.157, 92.0) },
    700: { $value: oklch(0.578, 0.128, 92.0) },
    800: { $value: oklch(0.444, 0.097, 92.0) },
    900: { $value: oklch(0.315, 0.065, 92.0) },
    950: { $value: oklch(0.248, 0.05, 92.0) },
  },
