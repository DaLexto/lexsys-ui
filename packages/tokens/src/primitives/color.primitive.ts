...
export const colorPrimitives: PrimitiveTokenGroup = {
  ...
  yellow: {
    ...
    300: { $value: "oklch(0.906 0.130 92.000)" },
    400: { $value: "oklch(0.852 0.168 92.000)" },
    500: { $value: "oklch(0.790 0.178 92.000)" },
    600: { $value: "oklch(0.706 0.157 92.000)" },
    700: { $value: "oklch(0.578 0.128 92.000)" },
    800: { $value: "oklch(0.444 0.097 92.000)" },
    900: { $value: "oklch(0.315 0.065 92.000)" },
    950: { $value: "oklch(0.248 0.050 92.000)" },
  },
