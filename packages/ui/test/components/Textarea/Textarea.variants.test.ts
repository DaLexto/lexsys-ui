...
describe("textareaVariants", () => {
  test("uses token-backed classes for base styling", () => {
    ...
    expect(className).toContain("rounded-[var(--nx-textarea-radius)]")
    expect(className).toContain("border-[var(--nx-textarea-border-color)]")
    expect(className).toContain("bg-[var(--nx-textarea-background)]")
    expect(className).toContain("min-h-[var(--nx-textarea-min-height-md)]")
  })
  ...
  test("includes focus, invalid, disabled, resize, and size classes", () => {
    ...
    expect(className).toContain(
      "focus-visible:ring-[var(--nx-textarea-focus-ring-color)]",
    )
    ...
    expect(className).toContain("min-h-[var(--nx-textarea-min-height-lg)]")
  })
})
