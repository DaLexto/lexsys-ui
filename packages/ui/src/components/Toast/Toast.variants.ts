...
export const toastViewportVariants = cva(
  [
    "fixed z-(--nx-toast-viewport-z-index) flex max-h-dvh w-[min(calc(100vw-2rem),var(--nx-toast-viewport-width))] flex-col gap-(--nx-toast-viewport-gap) p-(--nx-toast-viewport-padding)",
...
export const toastVariants = cva(
  [
    ...
    "border-(--nx-toast-border-color) data-[type=success]:border-(--nx-toast-success-border-color) data-[type=destructive]:border-(--nx-toast-destructive-border-color)",
  ].join(" "),
)
...
export const toastPositionerVariants = cva(
  "z-(--nx-toast-viewport-z-index) max-w-[min(var(--available-width,calc(100vw-2rem)),var(--nx-toast-viewport-width))]",
)
