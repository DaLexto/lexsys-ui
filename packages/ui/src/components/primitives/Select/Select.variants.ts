...
export const selectScrollArrowVariants = cva(
  "flex h-(--nx-select-scroll-arrow-height) items-center justify-center text-(--nx-select-icon-foreground)",
)

export const selectGroupVariants = cva("grid gap-(--nx-select-group-gap)")
