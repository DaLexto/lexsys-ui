...
**Related docs:** [UI_CATALOG.md](./UI_CATALOG.md) (compound vs leaf, named exports — **not** this doc), [UI.md](./UI.md), [UI_COMPOSITION.md](./UI_COMPOSITION.md)

**Scope:** CVA patterns, public variant props, token literals, and `.variants.ts` exports only. For installable composition (compound parts, registry version), use **[UI_CATALOG.md](./UI_CATALOG.md)**.
...
This inventory tracks **styling and variant-axis compliance** against [UI_VARIANTS.md](./UI_VARIANTS.md). It does **not** define compound-first export rules (M11) — those live in [UI.md](./UI.md) and [UI_CATALOG.md](./UI_CATALOG.md).

| Question                                                     | Read                                          |
| ------------------------------------------------------------ | --------------------------------------------- |
| Compound or leaf? Named component exports? Registry version? | [UI_CATALOG.md](./UI_CATALOG.md)              |
| Variant props, CVA rules, token literals?                    | This doc + [UI_VARIANTS.md](./UI_VARIANTS.md) |
| Composition layers and install paths?                        | [UI_COMPOSITION.md](./UI_COMPOSITION.md)      |
...
| --------------- | ----------------------------------------------------- | --------------------- | ------------------------------------------------------------------------------------------------------- | ----------------------------------------- | --------------------------------------------------------------------------------------- | ----------------- | ------- |
| **Accordion**   | —                                                     | CVA slots             | `accordionVariants`, item, header, trigger, panel                                                       | [catalog](./UI_CATALOG.md#inventory)      | `opacity-50`                                                                            | variants + render | PR4     |
...
| **Checkbox**    | `size` (root)                                         | CVA slots             | `checkboxVariants`, `checkboxIndicatorVariants` (+ orphaned `checkboxLabelVariants` — use `FieldLabel`) | [M11 compound](./UI_CATALOG.md#inventory) | `opacity-50`                                                                            | variants + render | PR2     |
...
| **Drawer**      | `size`                                                | CVA slots + compounds | 12 slot variants                                                                                        | [M11 compound](./UI_CATALOG.md#inventory) | `opacity-50`, `z-30`, `className:` compounds, viewport calc                             | variants + render | PR3     |
...
| **Menu**        | —                                                     | CVA slots             | 14 slot variants                                                                                        | [M11 compound](./UI_CATALOG.md#inventory) | `opacity-50`                                                                            | variants + render | PR3     |
...
| **Progress**    | `size` on **`ProgressTrack`** (not root)              | CVA slots             | 5 slot variants (root, track, indicator, label, value)                                                  | [M11 compound](./UI_CATALOG.md#inventory) | —                                                                                       | variants + render | PR2     |
...
| **Slider**      | — (size on parts TBD)                                 | CVA slots             | 7 slot variants (root, control, track, indicator, thumb, label, value)                                  | [M11 compound](./UI_CATALOG.md#inventory) | `opacity-50`                                                                            | variants + render | PR2     |
| **Switch**      | `size` (root)                                         | CVA slots             | `switchVariants`, `switchThumbVariants`                                                                 | [M11 compound](./UI_CATALOG.md#inventory) | `opacity-50`                                                                            | variants + render | PR2     |
...
**Shipped PR #30 (variant rows pending):** Autocomplete, CheckboxGroup, Combobox, ContextMenu, Menubar, NavigationMenu, OtpField, PreviewCard, Toolbar — composition in [UI_CATALOG.md](./UI_CATALOG.md).
...
See [UI_CATALOG.md § Generation and drift checks](./UI_CATALOG.md#generation-and-drift-checks).
...
**Composition pass (M11):** Shipped on `dev` — export and registry inventory in [UI_CATALOG.md](./UI_CATALOG.md). This doc’s primitive rows were refreshed for M11-touched variant axes only; blocks/templates are out of scope.
...
- [UI_CATALOG.md](./UI_CATALOG.md) — installable inventory (canonical for compound vs leaf)
- [UI_VARIANTS.md](./UI_VARIANTS.md) — variant contract this audit enforces
