...
- [Tokens](#tokens)
  - [Token build fails with MISSING_REFERENCE](#token-build-fails-with-missingreference)
  - [Token build fails with CIRCULAR_REFERENCE](#token-build-fails-with-circularreference)
  - [Token build fails with REFERENCE_POINTS_TO_BRANCH](#token-build-fails-with-referencepointstobranch)
