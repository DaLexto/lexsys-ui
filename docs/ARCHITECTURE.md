...
**Shipped today:** 42 primitives; blocks (FormField, SettingsPanel, Sidebar, AuthForm, CommandPalette, Empty); pilot template (DashboardShell). **Pages** remain consumer-owned.
