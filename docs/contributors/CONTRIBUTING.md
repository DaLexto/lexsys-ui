...
Use [Conventional Commits](https://www.conventionalcommits.org/) with monorepo scopes (`tokens`, `ui`, `registry`, `cli`, `docs`, `ci`, …). See [`.cursor/rules/git-commits.mdc`](../../.cursor/rules/git-commits.mdc) for repository conventions.
