...
- Style files starting with the generated JSDoc header (`AUTO-GENERATED FILE` /
  `Generated by @dalexto/lexsys-tokens`) are auto-updated without conflict
  because they are not user-owned.
